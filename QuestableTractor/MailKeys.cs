...
namespace NermNermNerm.Stardew.QuestableTractor
{
    public static class MailKeys
    {
        ...
        public static void EditAssets(IDictionary<string, string> mailItems)
        {
            ...
            mailItems[MailKeys.EvelynPointsToAlex] = "Hello Dear,^I gave what you said a lot of thought and I think I have a way.  George would be really uncomfortable with you doing work he would want to do.^But George has had to get used to letting Alex do a lot of things for him already.^I talked to Alex about it, but he is not comfortable with the idea.  Maybe if someone nearer his own age, who he trusted, talked to him he would come around.^Good luck!^ - Granny";
