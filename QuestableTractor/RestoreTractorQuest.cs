...
namespace NermNermNerm.Stardew.QuestableTractor
{
        ...
        : BaseQuest<RestorationState>
    {
        ...
        public override void CheckIfComplete(NPC n, Item? item)
        {
            ...
            {
                this.Spout(n, "An old tractor you say?#$b#I know your Grandfather had one - I thought he had sold it off before he died.  He never could keep it on the furrows.$h#$b#If you want to get it fixed, I suggest you talk to Robin's son, Sebastian; he's actually quite the gearhead.  Maybe he can help.");
                this.State = RestorationState.TalkToSebastian;
            }
            else if (n?.Name == "Sebastian" && this.State == RestorationState.TalkToSebastian)
            {
                this.Spout(n, "Let me get this straight - I barely know who you are and I'm supposed to fix your rusty old tractor?$a#$b#Sorry, but I've got a lot of stuff going on and can't really spare the time.");
            ...
            {
                this.Spout(n, "Trust me, I'm working on it, but I also have my day-gig to worry about.  I work odd hours, so you might not be around when I'm working on it.  Oh and thanks for the coffee.");
                Game1.drawDialogue(n);
            ...
            {
                this.Spout(n, "I made a lot of progress last night.  Most of it is cleaning up okay, but the engine itself is, well, it seems a little out of the ordinary. . .");
                Game1.drawDialogue(n);
                this.hasDoneStatusCheckToday = true;
            }
